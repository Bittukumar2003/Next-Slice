    ...
    <>
      ...
      <div className="container mx-auto  dark:bg-gray-900">
        <div className="my-6 space-x-5">
          <button
            className={`border-black rounded-full  dark:text-gray-100 dark:border-white border-2 py-1 px-3 ${
        ...
        {categoryArray.map((category) => {
          return (
            <>
              <div
                key={category}
                className=" text-4xl mt-10 mb-3 uppercase font-bold  dark:text-gray-400"
              >
                {category}
              </div>
              <hr />
